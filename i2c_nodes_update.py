...
def flashing():
    ...
    sleep(0.5)
    os.system("sudo avrdude -v -p atmega328p -c arduino -P /dev/ttyS0 -b 57600 -U flash:w:/home/"+user+"/RH-ota/firmware/reset_no_s.hex:i")
    sleep(1)
...
#  sudo avrdude -v -p atmega328p -c arduino -P /dev/ttyUSB0 -b 57600 -U flash:w:/home/pi/RH-ota/firmware/reset_no_s.hex:i
